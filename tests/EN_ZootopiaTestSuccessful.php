...
public function testPosTagging1630054954_4382() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT DET VER:ind+past+3+p ART-M:s NOUN-m:p PRO-DEMO-M-S PPAST:part+past+m+s ADJ:pos+m+s NOUN-m:s SENT");
}
...
public function testPosTagging1630055036_7446() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-1-M-S AUX:inf+pres VER:ger+pres VER:inf+pres NUM NOUN-m:s SENT:exclam");
}
...
public function testPosTagging1630055171_635() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT CON:cond PRO-PERS-2-M-S AUX:inf+pres ADV:neg VER:inf+pres NOUN-m:s ADJ:pos+m+s PON:sep PRO-PERS-2-M-S VER:inf+pres ADV VER:inf+pres SENT");
}
...
public function testPosTagging1630055188_3364() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT VER:ind+pres+3+s PRO-PERS-3-M-S VER:ind+pres+3+s VER:ger+pres VER:inf+pres ADJ:pos+m+s PON:sep SENT");
}
...
public function testPosTagging1630055212_1227() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ADJ:pos+m+s SENT ADV VER:ind+pres+3+s ADV PPAST:part+past+m+s PRE NOUN-m:s NOUN-m:s SENT NOUN-m:p AUX:inf+pres ADV:neg VER:inf+pres PRO-DEMO-M-S SENT");
}
...
public function testPosTagging1630055214_7791() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ADV SENT ADV SENT");
}
...
public function testPosTagging1630055222_4930() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT CON PRO-PERS-1-M-S AUX:inf+pres VER:ger+pres VER:inf+pres ART-M:s NOUN-m:s PRE ADJ:pos+m+s NOUN-m:s SENT");
}
...
public function testPosTagging1630055351_8679() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT CON:or PRO-PERS-1-M-S AUX:inf+pres VER:ger+pres VER:inf+pres ADJ:pos+m+s ADJ:pos+m+s ADJ:pos+m+s NOUN-m:s NOUN-m:s SENT");
}
...
public function testPosTagging1630055360_1355() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT NOUN-m:s VER:ind+pres+2+s PRO-PERS-2-M-S VER:ger+pres VER:inf+pres SENT:qst VER:inf+pres SENT:qst");
}
...
public function testPosTagging1630055384_636() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ADV:mod VER:inf+pres ADJ:pos+m+s ART-M:s NOUN-m:p PRE NOUN-m:s SENT");
}
...
public function testPosTagging1630055620_45() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-2-M-S PPAST:part+past+m+s ADV SENT:qst VER:inf+pres PRE PRO-PERS-3-F-S NOUN-m:s NOUN-m:s SENT:exclam");
}
...
public function testPosTagging1630055761_5171() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-2-M-S AUX:ind+pres+2+s VER:ger+pres VER:inf+pres PRE VER:inf+pres DET PRE PRO-PERS-3-M-P SENT");
}
...
public function testPosTagging1630055875_7090() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ADV VER:ind+pres+3+s ADV PPAST:part+past+m+s PRE NOUN-m:s NOUN-m:s SENT");
}

public function testPosTagging1630055877_8909() {
	$PipelinePosTagging = new PipelinePosTagging();
	$PipelinePosTagging->language = "en";
...
public function testPosTagging1630055942_5863() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT NPR PRE PRO-PERS-3-F-S NOUN-m:s PON:sep ART-M:s ADV:qty PRE NOUN-m:s ADJ:pos+m+s NOUN-m:s NOUN-m:s SENT");
}
...
public function testPosTagging1630056199_4277() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT CON PRO-PERS-3-M-S VER:ind+pres+3+s ADV ADV VER:ind+pres+3+s ADV:neg NOUN-m:s SENT");
}

public function testPosTagging1630056214_9471() {
	$PipelinePosTagging = new PipelinePosTagging();
	$PipelinePosTagging->language = "en";

	$sentence = "You know what, pretty much all predators. And Zootopia's full of them.";
	$pos_arr = $PipelinePosTagging->transform($sentence);
	$PipelinePosTagging = null;

	$pos_arr = NaiPOsArr::flatPosArr($pos_arr);

	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-2-M-S VER:inf+pres NOUN-m:s PON:sep ADJ:pos+m+s ADV:qty DET NOUN-m:p SENT CON ART-M:s NOUN-m:s PRE NPR PRE PRO-PERS-3-M-P SENT");
}
...
public function testPosTagging1630056323_3813() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ADJ:pos+m+s SENT:exclam NOUN-m:s VER:ind+pres+3+s SENT:exclam");
}
...
public function testPosTagging1630056332_6948() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT INT:conf PON:sep VER:inf+pres VER:inf+pres SENT:exclam INT:leav SENT:exclam");
}
...
public function testPosTagging1630056350_7044() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT INT:leav PON:sep PRO-INDEF-P-S SENT:exclam");
}
...
public function testPosTagging1630056424_2498() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT CON PRO-PERS-1-M-S ADV VER:inf+pres ADV SENT");
}
...
public function testPosTagging1630056797_5893() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ART-M:s NOUN-m:s NOUN-m:s VER:ind+pres+3+s VER:ind+pres+3+s ADV PRE ADJ:pos+m+s PON:sep NOUN-m:s PON:sep VER:ger+pres NOUN-m:s PON:sep VER:ger+pres PRO-PERS-2-M-S SENT");
}
...
public function testPosTagging1630056851_768() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT INT:conf SENT:exclam PRO-INDEF-P-S VER:inf+pres SENT");
}
...
public function testPosTagging1630057127_3606() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT NUM NOUN-m:p SENT PRO-PERS-1-M-S AUX:inf+pres ADV:neg VER:ger+pres VER:inf+pres NUM NOUN-m:p SENT");
}
...
public function testPosTagging1630057130_2545() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-1-M-S AUX:inf+pres VER:ger+pres VER:inf+pres NUM NOUN-m:p SENT");
}
...
public function testPosTagging1630057264_3675() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-2-M-S AUX:ind+pres+2+s VER:ger+pres VER:inf+pres PRE VER:inf+pres ADJ:pos+m+s NOUN-m:s ADV NOUN-m:s ADV PON:sep NOUN-m:s NOUN-m:s SENT");
}
...
public function testPosTagging1630057413_1554() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT INT:conf PON:sep PRO-PERS-1-M-S PPAST:part+past+m+s VER:inf+pres PRO-PERS-2-M-S ADJ:pos+m+s PRE PRE NOUN-m:s SENT");
}
...
public function testPosTagging1630057671_8287() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "INT:other PRO-DEMO-M-S VER:ind+pres+3+s ADJ:pos+m+s NOUN-m:s SENT PRO-PERS-3-M-S VER:ind+pres+3+s ADJ:pos+m+s PRO-DEMO-M-S PRO-PERS-1-M-S VER:inf+pres PRO-INDEF-M-S ADV ADV PON:sep VER:ger+pres SENT");
}
...
public function testPosTagging1630057717_7613() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT INT:leav PON:sep ADV SENT");
}
...
public function testPosTagging1630057804_681() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-2-M-S VER:inf+pres PRO-PERS-1-M-S NOUN-m:s PON:sep PRO-PERS-1-M-S VER:inf+pres VER:inf+pres ADJ:pos+m+s NOUN-m:s ADJ:pos+m+s SENT");
}
...
public function testPosTagging1630058731_4268() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT VER:inf+pres ADJ:pos+m+s PON:sep ADV PON:sep CON:or PRO-PERS-3-M-S VER:inf+pres ADV:neg ADV VER:inf+pres ADJ:pos+m+s NOUN-m:p VER:ger+pres PPAST:part+past+m+s SENT");
}
...
public function testPosTagging1630058749_953() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-WH-M-S ADV PPAST:part+past+m+s ART-M:s NOUN-m:s PRE VER:inf+pres PRE VER:inf+pres NOUN-m:s ADV CON PRE NOUN-m:s NOUN-m:s SENT");
}
...
public function testPosTagging1630058752_9066() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT INT:conf PON:sep VER:inf+pres SENT NOUN-m:s VER:ind+pres+3+s PRE NPR SENT");
}
...
public function testPosTagging1630058785_3830() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-2-M-S VER:inf+pres ADV VER:inf+pres PRE ADJ:pos+m+s NOUN-m:s SENT");
}
...
public function testPosTagging1630058832_9014() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT CON ADV SENT ART-M:s ADV PRE NOUN-m:s ADJ:pos+m+s CON SENT");
}
...
public function testPosTagging1630059205_3796() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ADV:neg ADV SENT");
}
...
public function testPosTagging1630059272_7989() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ADV:neg ADV SENT:exclam NOUN-m:s SENT");
}
...
public function testPosTagging1630059313_2135() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-1-M-S VER:inf+pres VER:inf+pres VER:inf+pres ADV:plc SENT");
}
...
public function testPosTagging1630059362_9830() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-1-M-P VER:inf+pres NUM ADJ:pos+m+s NOUN-m:p SENT PRO-PERS-3-M-S PPAST:part+past+m+s ADV ADV VER:inf+pres SENT");
}
...
public function testPosTagging1630059457_579() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ADV SENT PRO-PERS-1-M-S AUX:inf+pres VER:ger+pres PRE VER:inf+pres PRO-DEMO-M-S NOUN-m:s SENT");
}
...
public function testPosTagging1630059500_6186() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ART-M:s ADJ:pos+m+s NOUN-m:s NOUN-m:s VER:ind+pres+3+s ADV VER:ger+pres PRE VER:inf+pres ADJ:pos+m+s SENT");
}
...
public function testPosTagging1630059505_6378() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT NOUN-m:s NOUN-m:s VER:ind+pres+3+s ADV VER:ger+pres AUX:inf+pres ADV VER:part+past+m+s SENT:exclam");
}
...
public function testPosTagging1630066993_2565() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT INT:enter PON:sep NOUN-m:p PON:sep PRO-PERS-2-M-S AUX:ind+pres+2+s VER:ger+pres PRE VER:inf+pres ART-M:s NOUN-m:s SENT PRO-PERS-1-M-S VER:inf+pres VER:inf+pres PRE VER:inf+pres SENT");
}
...
public function testPosTagging1630067048_7676() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-1-M-S VER:inf+pres PRO-INDEF-P-S SENT");
}
...
public function testPosTagging1630067320_4591() {
	$PipelinePosTagging = new PipelinePosTagging();
	$PipelinePosTagging->language = "en";

	$sentence = "or the only place you'll be selling popsicles is the prison cafeteria.";
	$pos_arr = $PipelinePosTagging->transform($sentence);
	$PipelinePosTagging = null;

	$pos_arr = NaiPOsArr::flatPosArr($pos_arr);

	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT CON:or ART-M:s ADV NOUN-m:s PRO-PERS-2-M-S VER:inf+pres AUX:inf+pres VER:ger+pres NOUN-m:p VER:ind+pres+3+s ART-M:s NOUN-m:s NOUN-m:s SENT");
}
...
public function testPosTagging1630067337_9643() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-2-M-S PRE NOUN-m:s ADV PON:sep NPR SENT PRO-PERS-2-M-S VER:ger+pres VER:inf+pres NUM PRE DET SENT");
}
...
public function testPosTagging1630067599_8849() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT INT:jubi ADV ADV:qty SENT");
}
...
public function testPosTagging1630067614_5077() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT DET NOUN-m:p PON:sep PRO-PERS-3-M-P VER:inf+pres ADJ:pos+m+s SENT");
}
...
public function testPosTagging1630067719_9589() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT DET NOUN-m:p VER:inf+pres DET NOUN-m:p ADV NPR ART-M:s NOUN-m:s SENT");
}
...
public function testPosTagging1630067842_937() {
	$PipelinePosTagging = new PipelinePosTagging();
	$PipelinePosTagging->language = "en";
...
public function testPosTagging1630068154_5618() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT NOUN-m:s PON:sep PRO-PERS-1-M-S VER:inf+pres ARTPRE ADJ:pos+m+s NOUN-m:s SENT");
}
...
public function testPosTagging1630068304_1570() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRE NOUN-m:s PPAST:part+past+m+s NPR PON:sep CON ART-M:s PRE PRE NOUN-m:s NPR SENT:exclam");
}
...
public function testPosTagging1630068358_9483() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-1-M-S PPAST:part+past+m+s ADV VER:inf+pres ADJ:pos+m+s VER:inf+pres NOUN-m:s SENT");
}
...
public function testPosTagging1630068387_9796() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ADV PRO-PERS-3-M-P AUX:inf+pres VER:inf+pres ADV PRE ADJ:pos+m+s NOUN-m:s PRE VER:inf+pres PRO-PERS-3-M-S SENT");
}
...
public function testPosTagging1630068411_181() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ADV PON:sep ADV PRO-PERS-2-M-S VER:ind+pres+2+s ADJ:pos+m+s NOUN-m:s SENT");
}
...
public function testPosTagging1630068428_2660() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ADJ:pos+m+s ADJ:pos+m+s PON:sep PRO-PERS-2-M-S VER:inf+pres ADV PRE NOUN-m:s SENT");
}
...
public function testPosTagging1630068561_3786() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ADV PON:sep INT:other SENT");
}
...
public function testPosTagging1630068595_8767() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT CON PRO-PERS-3-M-S AUX:ind+pres+3+s ADV:neg VER:inf+pres PRO-PERS-1-M-S SENT ADV PRO-PERS-1-M-P VER:inf+pres VER:inf+pres SENT:exclam");
}
...
public function testPosTagging1630068780_1033() {
	$PipelinePosTagging = new PipelinePosTagging();
	$PipelinePosTagging->language = "en";
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT CON PRO-PERS-1-M-S ADV PPAST:part+past+m+s ADV:neg VER:inf+pres ADV ADJ:pos+m+s ART-M:s NOUN-m:s PRE NOUN-m:s SENT");
}
...
public function testPosTagging1630068854_4018() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-1-M-S PPAST:part+past+m+s PRO-PERS-2-M-S ADV PRE VER:inf+pres ADJ:pos+m+s NOUN-m:s ADV:plc ADV CON ADV:plc PRO-PERS-2-M-S VER:ind+pres+2+s SENT");
}
...
public function testPosTagging1630069133_7220() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT CON PRO-PERS-3-M-S ADV PPAST:part+past+m+s SENT");
}
...
public function testPosTagging1630069412_4364() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ADV PON:sep PRO-PERS-1-M-S AUX:inf+pres VER:inf+pres PRO-PERS-2-M-S VER:ind+pres+2+s PRE ADJ:pos+m+s ADJ:pos+m+s SENT");
}
...
public function testPosTagging1630069416_6228() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ADV PRO-PERS-1-M-S AUX:inf+pres ADV VER:ger+pres VER:inf+pres PRO-PERS-2-M-S PRE ADJ:pos+m+s ADJ:pos+m+s NOUN-m:s SENT:exclam");
}
...
public function testPosTagging1630069423_3168() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-1-M-S AUX:inf+pres VER:ger+pres VER:inf+pres VER:inf+pres SENT:exclam ADV:neg PON:sep PRO-PERS-2-M-S PON:sep NOUN-m:s SENT:qst");
}
...
public function testPosTagging1630070998_7696() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-2-M-S VER:inf+pres PRO-PERS-1-M-S AUX:inf+pres VER:ger+pres VER:inf+pres PRE NOUN-m:s SENT:qst");
}
...
public function testPosTagging1630071121_7932() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT NOUN-m:s PRE PRO-PERS-2-M-S NOUN-m:p AUX:ind+past+3+p VER:ger+pres VER:inf+pres PRO-PERS-3-F-S PON:sep VER:ind+past+3+p PRO-PERS-2-M-S SENT:qst");
}
...
public function testPosTagging1630071135_8917() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT CON PRO-DEMO-M-S VER:ind+pres+3+s ADV NOUN-m:s PRO-PERS-1-M-P AUX:ind+pres+2+s VER:ger+pres VER:inf+pres SENT");
}
...
public function testPosTagging1630071223_8036() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ADV VER:inf+pres PRO-PERS-3-M-P VER:inf+pres PRO-DEMO-M-S PRO-PERS-3-M-P VER:inf+pres PRE PRO-PERS-2-M-S SENT");
}
...
public function testPosTagging1630071308_4641() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT CON PON:sep ADV NPR PON:sep PRO-PERS-1-M-S AUX:ind+past+1+s VER:ger+pres VER:inf+pres PRE SENT");
}
...
public function testPosTagging1630071319_7158() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-1-M-S AUX:ind+past+1+s VER:ger+pres VER:inf+pres NOUN-m:s PRE PRE NOUN-m:s SENT");
}
...
public function testPosTagging1630071518_8121() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ABL PON:sep VER:ind+pres+3+s PRO-PERS-3-M-S VER:ger+pres VER:inf+pres SENT:qst");
}
...
public function testPosTagging1630071526_6982() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-1-M-S AUX:ind+past+1+s ADV VER:ger+pres VER:inf+pres PRO-WH-M-S VER:inf+pres PRO-DEMO-M-S PRO-PERS-3-M-P PPAST:part+past+m+s PRE PRO-PERS-1-M-S SENT");
}
...
public function testPosTagging1630071533_7861() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT CON:cond ART-M:s ADV PRE NOUN-m:s VER:ger+pres VER:inf+pres PRE NOUN-m:s ADV ADJ:pos+m+s CON ADJ:pos+m+s SENT");
}
...
public function testPosTagging1630071641_7978() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-1-M-S VER:inf+pres NOUN-m:s NOUN-m:s NOUN-m:s VER:ind+pres+3+s VER:ger+pres VER:inf+pres PRO-PERS-2-M-S ADV PRO-PERS-3-M-S ADV SENT");
}
...
public function testPosTagging1630071649_5714() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT NOUN-m:s PON:sep CON:cond PRO-PERS-1-M-P PPAST:part+past+m+s ADV VER:inf+pres DET ADV:qty ADJ:pos+m+s SENT");
}
...
public function testPosTagging1630071776_3835() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT NOUN-m:s ADV VER:inf+pres PRO-PERS-1-M-S VER:inf+pres PRO-DEMO-M-S ADJ:pos+m+s SENT");
}
...
public function testPosTagging1630071778_9534() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-2-M-S ADV:neg ADV VER:inf+pres PRE ART-M:s NOUN-m:s PRE NOUN-m:s SENT:exclam");
}
...
public function testPosTagging1630071808_3505() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-1-M-S ADV VER:inf+pres PRE VER:inf+pres NOUN-m:s PRO-DEMO-M-S ADJ:pos+m+s SENT");
}
...
public function testPosTagging1630071889_2633() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-WH-M-S VER:ind+pres+2+s DET NOUN-m:p SENT:qst");
}
...
public function testPosTagging1630071966_8426() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT NOUN-m:p SENT VER:inf+pres PRE DET ADJ:pos+m+s PON:sep ADJ:pos+m+p SENT");
}
...
public function testPosTagging1630071983_8799() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT VER:inf+pres PRO-PERS-2-M-S PRE NOUN-m:s NUM PRE PRO-PERS-3-M-P VER:ind+pres+3+s VER:ger+pres VER:inf+pres SENT");
}
...
public function testPosTagging1630072026_3433() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-WH-M-S PRO-PERS-1-M-S ADV VER:inf+pres SENT");
}
...
public function testPosTagging1630072074_5190() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-2-M-S AUX:ind+pres+2+s VER:ger+pres VER:inf+pres PRE NOUN-m:s SENT");
}
...
public function testPosTagging1630072182_3170() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-1-M-P AUX:ind+pres+2+s VER:ger+pres VER:inf+pres PRO-PERS-2-M-S ADV PRE ADV:plc ADV SENT");
}
...
public function testPosTagging1630072235_6891() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-WH-M-S AUX:inf+pres VER:part+past+m+s ADJ:pos+m+s PON:sep ART-M:s PON:sep NOUN-m:p ADJ:pos+m+s SENT");
}
...
public function testPosTagging1630072245_739() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ADV PON:sep PRO-PERS-1-M-S PPAST:part+past+m+s VER:inf+pres PRO-DEMO-M-S ADV ADJ:pos+m+s PRE PON:quote VER:ger+pres PRO-INDEF-M-S SENT PON:quote SENT");
}
...
public function testPosTagging1630072441_8358() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT CON ADV VER:inf+pres PRO-PERS-2-M-S VER:inf+pres PRO-PERS-3-M-P AUX:ind+pres+2+s VER:ger+pres VER:inf+pres ADV ADJ:pos+m+s NOUN-m:s SENT");
}
...
public function testPosTagging1630072456_8652() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ART-M:s ADV:plc PRE PRO-INDEF-M-S SENT");
}
...
public function testPosTagging1630072459_9477() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT NOUN-m:s PON:sep PRO-PERS-2-M-S VER:inf+pres PRE VER:inf+pres PON:sep ADV SENT:exclam");
}
...
public function testPosTagging1630072473_1625() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-DEMO-M-S VER:ind+pres+3+s PRO-PERS-3-M-S SENT PRO-PERS-1-M-S VER:inf+pres ADJ:pos+m+s PON:sep PRO-PERS-2-M-S VER:ind+pres+2+s ADJ:pos+m+s SENT ART-M:s ADJ:pos+m+s PRE PRO-INDEF-P-S SENT:exclam");
}
...
public function testPosTagging1630072483_4816() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-1-M-P VER:inf+pres VER:inf+pres NPR SENT:exclam");
}
...
public function testPosTagging1630072490_3480() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT NOUN-m:s NPR SENT:exclam ADV:neg ADV SENT:exclam");
}
...
public function testPosTagging1630072703_9780() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRE NUM PON:sep NUM NUM NOUN-m:p PON:sep PRO-PERS-1-M-P VER:inf+pres DET DET VER:ger+pres NOUN-m:p SENT");
}
...
public function testPosTagging1630072717_2221() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ADV ADV PON:sep PRO-PERS-1-M-S VER:inf+pres VER:inf+pres NOUN-m:p ADV PRE ART-M:s NOUN-m:s PRO-WH-M-S PPAST:part+past+m+s ART-M:s NOUN-m:s SENT");
}
...
public function testPosTagging1630072888_3680() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT INT:surp PON:sep ADV VER:ind+pres+3+s PRE PON:quote PRO-PERS-3-M-P PON:quote ADV SENT:qst");
}
...
public function testPosTagging1630073041_757() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-1-M-P AUX:inf+pres ADV:neg VER:inf+pres ADV DET NOUN-m:p VER:inf+pres VER:ger+pres SENT");
}
...
public function testPosTagging1630073102_1991() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-3-M-P AUX:ind+pres+2+s VER:ger+pres VER:inf+pres PRO-PERS-1-M-S PRE VER:ind+pres+3+s SENT PRO-PERS-3-M-S VER:ind+pres+3+s ADJ:pos+m+s SENT");
}
...
public function testPosTagging1630073229_4795() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT INT:conf SENT PRO-PERS-3-M-S ADJ:pos+m+s VER:ind+pres+3+s SENT PRO-PERS-1-M-P VER:inf+pres PRE PRO-PERS-3-M-S ADV SENT");
}
...
public function testPosTagging1630073236_1475() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT CON PRO-PERS-1-M-P PPAST:part+past+m+s ADV AUX:inf+pres VER:part+past+m+s PRO-PERS-3-M-S PPAST:part+past+m+s PRO-PERS-2-M-S ADV:neg PPAST:part+past+m+s ADJ:pos+m+s NOUN-m:p SENT");
}
...
public function testPosTagging1630073320_1710() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ADV PON:sep PRO-PERS-1-M-S PPAST:part+past+m+s PRO-PERS-2-M-S DET DET NOUN-m:p SENT");
}
...
public function testPosTagging1630073345_9695() {
	$PipelinePosTagging = new PipelinePosTagging();
	$PipelinePosTagging->language = "en";

	$sentence = "Gid's talking about those flowers, Judy.";
	$pos_arr = $PipelinePosTagging->transform($sentence);
	$PipelinePosTagging = null;

	$pos_arr = NaiPOsArr::flatPosArr($pos_arr);

	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ART-M:s NOUN-m:s PRE PRO ADV DET NOUN-m:p PON:sep NPR SENT");
}
...
public function testPosTagging1630073348_9607() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-1-M-S VER:inf+pres PRO-PERS-3-M-P PRE VER:inf+pres ART-M:s NOUN-m:p ADJ:pos+m+s ART-M:s VER:inf+pres SENT");
}
...
public function testPosTagging1630073651_7177() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-2-M-S AUX:ind+pres+2+s VER:ger+pres PRE ADJ:pos+m+s NOUN-m:s PON:sep CON:cond SENT ADJ:pos+m+s PON:sep ADJ:pos+m+s PON:sep ADJ:pos+m+s SENT");
}
...
public function testPosTagging1630073664_719() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-1-M-P AUX:ind+pres+2+s VER:ger+pres VER:inf+pres ART-M:s NOUN-m:s NOUN-m:p SENT");
}
...
public function testPosTagging1630073672_7503() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-1-M-S PPAST:part+past+m+s PRO-PERS-2-M-S SENT PRO-PERS-1-M-S VER:inf+pres PRO-INDEF-P-S SENT");
}
...
public function testPosTagging1630073677_2732() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT NOUN-m:s ADJ:pos+m+s ADV SENT NOUN-m:s PRO-PERS-2-M-S VER:inf+pres PON:sep PRO-PERS-1-M-S PPAST:part+past+m+s PRO-PERS-3-M-S SENT");
}
...
public function testPosTagging1630073688_7871() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT INT:enter PON:sep NUM ADJ:pos+m+s SENT:exclam NUM SENT:exclam VER:inf+pres PRO-PERS-1-M-S NUM NOUN-m:s SENT:exclam INT:conf SENT:exclam");
}
...
public function testPosTagging1630073766_1539() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT NOUN-m:s VER:ind+past+3+p PRO-PERS-2-M-S VER:ger+pres VER:inf+pres PRE DET NOUN-m:s NOUN-m:p PON:sep NPR SENT:qst");
}
...
public function testPosTagging1630073829_5550() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-1-M-S AUX:inf+pres VER:ger+pres VER:inf+pres PRO-PERS-3-F-S NPR SENT");
}
...
public function testPosTagging1630073940_8117() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT INT:conf PON:sep VER:ind+pres+3+s ADV ADJ:pos+m+s ART-M:s PPAST:part+past+m+s PRE NPR ART-M:s NOUN-m:s PRE NOUN-m:s NOUN-m:p SENT");
}
...
public function testPosTagging1630074051_9447() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT NOUN-m:s CON NPR VER:ind+pres+2+s ADJ:pos+m+s PON:sep ADV PRO-PERS-1-M-S AUX:inf+pres VER:ger+pres ADV SENT");
}
...
public function testPosTagging1630074057_6286() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT NOUN-m:s VER:ind+pres+2+s PRO-PERS-2-M-S VER:ger+pres SENT:qst PRO-PERS-3-M-S VER:ind+pres+3+s VER:ger+pres VER:inf+pres PRO-PERS-2-M-S SENT:exclam");
}
...
public function testPosTagging1630074098_3975() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ADJ:pos+m+s PON:sep PRO-PERS-2-M-S VER:ind+pres+2+s PRE NOUN-m:s ADV SENT:qst");
}
...
public function testPosTagging1630074167_6524() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "INT:other PRO-PERS-1-M-S AUX:inf+pres VER:inf+pres PRO-DEMO-M-S ADJ:pos+m+s ART-M:s NOUN-m:s NOUN-m:s SENT");
}
...
public function testPosTagging1630074186_85() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ADJ:pos+m+s ADJ:pos+m+s SENT:exclam");
}
...
public function testPosTagging1630074258_9024() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT INT:conf SENT:exclam PRO-PERS-1-M-P VER:inf+pres VER:inf+pres PRE ART-M:s NOUN-m:s SENT");
}
...
public function testPosTagging1630074289_345() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-1-M-S VER:inf+pres VER:inf+pres ADV CON PRO-PERS-1-M-S VER:inf+pres VER:inf+pres PRO-DEMO-M-S NOUN-m:s ADV SENT");
}
...
public function testPosTagging1630074306_625() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT INT:conf PON:sep ADV ADV VER:inf+pres SENT");
}
...
public function testPosTagging1630074332_2095() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-1-M-S AUX:inf+pres ADV:neg VER:ger+pres VER:inf+pres PRO-PERS-2-M-S NOUN-m:s SENT PRO-DEMO-M-S VER:ind+pres+3+s ADV:neg VER:ger+pres SENT");
}
...
public function testPosTagging1630074486_5165() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-3-M-S VER:inf+pres ADV:neg VER:inf+pres SENT:exclam");
}
...
public function testPosTagging1630074533_7814() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT DET VER:ind+pres+2+s NOUN-m:p SENT PRE ADJ:pos+m+s ART-M:s NOUN-m:s PRE NOUN-m:s SENT");
}
...
public function testPosTagging1630074644_4545() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ADV NOUN-m:s PPAST:part+past+m+s ADV CON PRO-WH-M-S PPAST:part+past+m+s VER:inf+pres NOUN-m:s SENT");
}
...
public function testPosTagging1630074806_4563() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT NPR NOUN-m:s SENT");
}
...
public function testPosTagging1630074871_4952() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT INT:conf PON:sep PRO-INDEF-P-S PON:sep VER:inf+pres ADJ:pos+m+s NOUN-m:p ADV SENT:exclam");
}
...
public function testPosTagging1630074885_1760() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT CON PRO-PERS-1-M-S ADV VER:inf+pres ADV PRE VER:inf+pres NOUN-m:s VER:ind+pres+3+s ADJ:pos+m+s SENT");
}
