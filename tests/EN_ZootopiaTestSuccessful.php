...
public function testPosTagging1630059073_1253() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-1-M-S PPAST:part+past+m+s ART-M:s NOUN-m:s SENT:exclam");
}
...
public function testPosTagging1630059213_9106() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT INT:conf PON:sep PRO-PERS-1-M-S ADV PPAST:part+past+m+s ADV:neg VER:inf+pres CON:cond PRO-PERS-2-M-S PPAST:part+past+m+s VER:inf+pres PRE VER:inf+pres PRO-PERS-3-M-S ADJ:pos+m+s NOUN-m:s SENT");
}
...
public function testPosTagging1630073845_141() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-3-M-P PPAST:part+past+m+s PRO-PERS-1-M-S NOUN-m:s PRO-PERS-1-M-S PPAST:part+past+m+s ADV:neg VER:inf+pres SENT");
}
...
public function testPosTagging1630074069_8027() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT PRO-PERS-3-M-S ADJ:pos+m+s VER:inf+pres ART-M:s ADJ:pos+m+s NOUN-m:s ADJ:pos+m+s NOUN-m:s SENT");
}
...
public function testPosTagging1630074673_8706() {
	...
	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ART-M:s ADV ADJ:pos+m+s ADJ:pos+m+s PRE PRO-PERS-1-M-P AUX:ind+pres+2+s VER:inf+pres SENT");
}
...
public function testPosTagging1631195954_3092() {
	$PipelinePosTagging = new PipelinePosTagging();
	$PipelinePosTagging->language = "en";

	$sentence = "All right, slick Nick, you're under arrest.";
	$pos_arr = $PipelinePosTagging->transform($sentence);
	$PipelinePosTagging = null;

	$pos_arr = NaiPOsArr::flatPosArr($pos_arr);

	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT INT:conf PON:sep ADJ:pos+m+s NPR PON:sep PRO-PERS-2-M-S VER:ind+pres+2+s ADV NOUN-m:s SENT");
}

public function testPosTagging1631196077_9058() {
	$PipelinePosTagging = new PipelinePosTagging();
	$PipelinePosTagging->language = "en";

	$sentence = "Gee, I don't know. How about selling food without a permit.";
	$pos_arr = $PipelinePosTagging->transform($sentence);
	$PipelinePosTagging = null;

	$pos_arr = NaiPOsArr::flatPosArr($pos_arr);

	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT INT:other PON:sep PRO-PERS-1-M-S AUX:inf+pres ADV:neg VER:inf+pres SENT ADV ADV VER:ger+pres NOUN-m:s ADV:qty PRE NOUN-m:s SENT");
}

public function testPosTagging1631517206_1848() {
	$PipelinePosTagging = new PipelinePosTagging();
	$PipelinePosTagging->language = "en";

	$sentence = "Now, predator and prey live in harmony.";
	$pos_arr = $PipelinePosTagging->transform($sentence);
	$PipelinePosTagging = null;

	$pos_arr = NaiPOsArr::flatPosArr($pos_arr);

	$this->assertEquals(implode(" ", array_column($pos_arr, 'features')), "SENT ADV:tim PON:sep NOUN-m:s CON NOUN-m:s VER:inf+pres PRE NOUN-m:s SENT");
}

public function testPosTagging1631518704_4833() {
	$PipelinePosTagging = new PipelinePosTagging();
	$PipelinePosTagging->language = "en";
